...
String PO_Ammount = ExcelKeywords.getCellValueByIndex(sheet01, 9, 5)

Float PO_GrandTotal_float = Float.parseFloat(GlobalVariable.PO_GrandAmount)
...
Float Ex1_FloatTransfer = Ex1_float - PO_GrandTotal_float
