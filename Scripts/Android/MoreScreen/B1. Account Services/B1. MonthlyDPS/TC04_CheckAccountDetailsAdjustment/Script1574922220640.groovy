...
String FD_Ammount = ExcelKeywords.getCellValueByIndex(sheet01, 7, 5)

Float FD_Ammount_float = Float.parseFloat(FD_Ammount)
...
Float Ex1_FloatTransfer = Ex1_float - FD_Ammount_float
