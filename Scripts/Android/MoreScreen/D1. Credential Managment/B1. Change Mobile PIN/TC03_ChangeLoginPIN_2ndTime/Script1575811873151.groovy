...
'User Input 1st PIN'
Mobile.setText(findTestObject('MoreScreen/D1. Credential Managment/B1. ChangeLoginPin/PIN Change - Old - Box - 01'), '9', 
    0)

'User Input 2nd PIN'
Mobile.setText(findTestObject('MoreScreen/D1. Credential Managment/B1. ChangeLoginPin/PIN Change - Old - Box - 02'), '8', 
    0)

'User Input 3rd PIN'
Mobile.setText(findTestObject('MoreScreen/D1. Credential Managment/B1. ChangeLoginPin/PIN Change - Old - Box - 03'), '7', 
    0)

'User Input 4th PIN'
Mobile.setText(findTestObject('MoreScreen/D1. Credential Managment/B1. ChangeLoginPin/PIN Change - Old - Box - 04'), '6', 
    0)
...
'User Input 6th PIN'
Mobile.setText(findTestObject('MoreScreen/D1. Credential Managment/B1. ChangeLoginPin/PIN Change - Old - Box - 06'), '4', 
    0)

Mobile.comment('User Input New PIN')

'User Input 1st PIN'
Mobile.setText(findTestObject('MoreScreen/D1. Credential Managment/B1. ChangeLoginPin/PIN Change - New - Box - 01'), '1', 
    0)

'User Input 2nd PIN'
Mobile.setText(findTestObject('MoreScreen/D1. Credential Managment/B1. ChangeLoginPin/PIN Change - New - Box - 02'), '2', 
    0)

'User Input 3rd PIN'
Mobile.setText(findTestObject('MoreScreen/D1. Credential Managment/B1. ChangeLoginPin/PIN Change - New - Box - 03'), '3', 
    0)

'User Input 4th PIN'
Mobile.setText(findTestObject('MoreScreen/D1. Credential Managment/B1. ChangeLoginPin/PIN Change - New - Box - 04'), '4', 
    0)
...
'User Input 6th PIN'
Mobile.setText(findTestObject('MoreScreen/D1. Credential Managment/B1. ChangeLoginPin/PIN Change - New - Box - 06'), '6', 
    0)
