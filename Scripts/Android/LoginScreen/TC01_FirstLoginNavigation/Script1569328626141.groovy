...
String applicationPath = GlobalVariable.appPath

String appPath = projectPath + applicationPath
...
//Mobile.verifyElementExist(findTestObject('LoginScreen/android.widget.ImageView0'), 0)
...
Mobile.tap(findTestObject('LoginScreen/android.widget.CheckBox0 - Remember ID'), 0)
