...
String CC_Own_Ammount = ExcelKeywords.getCellValueByIndex(sheet01, 11, 5)

Float CC_Own_Ammount_float = Float.parseFloat(CC_Own_Ammount)
...
Float Ex1_FloatTransfer = Ex1_float - CC_Own_Ammount_float
