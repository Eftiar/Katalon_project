...
while (Mobile.verifyElementNotExist(findTestObject('Dashboard/A1. AccountDetails/CreditCard - AMEX AGORA'), 10, FailureHandling.OPTIONAL)) {
    'Page Refreshing to get All Data'
    Mobile.callTestCase(findTestCase('Android/Utls/TC02_SwipeToptoBottom'), [:])
}

'User tap AMEX AGORA Credit Card from account Screen'
Mobile.tap(findTestObject('Dashboard/A1. AccountDetails/CreditCard - AMEX AGORA'), 0)
