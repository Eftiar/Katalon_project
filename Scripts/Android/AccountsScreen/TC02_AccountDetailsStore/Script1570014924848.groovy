...
String SavingAccName1 = Mobile.getText(findTestObject('AccountsScreen/Savings_Account_Name_01'), 0)

ExcelKeywords.setValueToCellByIndex(sheet01, 1, 0, SavingAccName1)

//Account Number 01 Saving into Excel
def SavingAccNumber1 = Mobile.getText(findTestObject('AccountsScreen/Savings_Account_Number_01'), 0)

ExcelKeywords.setValueToCellByIndex(sheet01, 1, 1, SavingAccNumber1)

//Account Balance 01 Saving into Excel
def SavingAccBalance1 = Mobile.getText(findTestObject('AccountsScreen/Saving_Account_Available_Balance_01'), 0)

ExcelKeywords.setValueToCellByIndex(sheet01, 1, 2, SavingAccBalance1)

//Account Name 02 Saving into Excel
String SavingAccName2 = Mobile.getText(findTestObject('AccountsScreen/Saving_Account_Name_02'), 0)

ExcelKeywords.setValueToCellByIndex(sheet01, 2, 0, SavingAccName2)

//Account Number 02 Saving into Excel
def SavingAccNumber2 = Mobile.getText(findTestObject('AccountsScreen/Saving_Account_Number_02'), 0)

ExcelKeywords.setValueToCellByIndex(sheet01, 2, 1, SavingAccNumber2)

//Account Balance 02 Saving into Excel
def SavingAccBalance2 = Mobile.getText(findTestObject('AccountsScreen/Saving_Account_Available_Balance_02'), 0)
