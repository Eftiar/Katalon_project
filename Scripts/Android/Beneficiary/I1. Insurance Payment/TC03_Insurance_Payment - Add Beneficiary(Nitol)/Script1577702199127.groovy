...
'User select dropdown Nitol'
Mobile.tapAtPosition(GlobalVariable.NitolInsurancePayment_X, GlobalVariable.NitolInsurancePayment_Y)

'User Input Nickname Eftiar'
Mobile.setText(findTestObject('Beneficiary Management/Beneficiary/Add Beneficiary - Insurant Payment/Nitol - Add Beneficiary/Nickname - Please enter here'), 
    nickName, 0)
