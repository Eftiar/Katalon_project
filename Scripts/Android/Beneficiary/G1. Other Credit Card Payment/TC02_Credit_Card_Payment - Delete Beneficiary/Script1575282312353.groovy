...
'User select Credit Card Payment Type'
...
Mobile.verifyElementExist(findTestObject('Beneficiary Management/Beneficiary/Delete Beneficiary - Other Credit Card Payment/Delete Beneficiary - Other Credit Card Payment'), 
    0)
