...
String CAT_Ammount = ExcelKeywords.getCellValueByIndex(sheet01, 2, 5)

Float CAT_Ammount_float = Float.parseFloat(CAT_Ammount)
...
Float Ex2_floatTransfer = Ex2_float - CAT_Ammount_float
