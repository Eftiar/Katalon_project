...
def TransferAmount = Mobile.getText(findTestObject('CityBankAccount/OwnAccount/TransferSuccessScreen/TransferSuccessScreen - Ammount'), 0, FailureHandling.CONTINUE_ON_FAILURE).replaceAll(',', '')

'Verify Transfer Amount is "1,200"'
Mobile.verifyMatch(TransferAmount, OAT_Amount, false, FailureHandling.CONTINUE_ON_FAILURE)
