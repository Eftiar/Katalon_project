...
String OAT_Ammount = ExcelKeywords.getCellValueByIndex(sheet01, 1, 5)

Float OAT_Ammount_float = Float.parseFloat(OAT_Ammount)
...
Float Ex1_FloatTransfer = Ex1_float + OAT_Ammount_float

'Verify Transfer Amount Added to this Account'
...
Float Ex2_floatTransfer = Ex2_float - OAT_Ammount_float

'Verify Transfer Amount Deducted from Account'
