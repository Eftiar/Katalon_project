...
'Tap on bKash Transfer'
Mobile.tap(findTestObject('Transfers Screen/Transfer to bKash'), 0)
...
if (Mobile.verifyElementExist(findTestObject('Beneficiary Management/Beneficiary/Add Beneficiary - Within City Bank/EmptyBeneficiaryMsg - TransferScreen'), 
    ...
    Mobile.callTestCase(findTestCase('Android/Beneficiary/E1. bKash Transfer/TC01_bKash Transfer - Add Beneficiary'), [('Nickname') : 'Rajib - BS23'
            , ('AccNumber') : '01679647916'], FailureHandling.CONTINUE_ON_FAILURE)
