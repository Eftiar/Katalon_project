...
String OBT_Ammount = ExcelKeywords.getCellValueByIndex(sheet01, 3, 5)

Float OBT_Ammount_float = Float.parseFloat(OBT_Ammount)
...
Float Ex2_floatTransfer = Ex2_float - OBT_Ammount_float
