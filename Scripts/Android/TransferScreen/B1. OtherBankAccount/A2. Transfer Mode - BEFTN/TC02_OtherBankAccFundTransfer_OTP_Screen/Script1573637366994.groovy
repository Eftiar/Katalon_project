...
Mobile.verifyElementText(findTestObject('OtherBankAccount/OtherBankAccount - OTP Screen/OTP Screen - Transfer Mode'), 'BEFTN')
...
Mobile.verifyElementText(findTestObject('OtherBankAccount/OtherBankAccount - OTP Screen/OTP Screen - Service Charge'), '0.00')
...
Mobile.verifyElementText(findTestObject('OtherBankAccount/OtherBankAccount - OTP Screen/OTP Screen - Vat Amount'), '0.00')
...
if (Mobile.verifyElementNotExist(findTestObject('Utls/Page Load - Loading'), 40, FailureHandling.OPTIONAL)) {
