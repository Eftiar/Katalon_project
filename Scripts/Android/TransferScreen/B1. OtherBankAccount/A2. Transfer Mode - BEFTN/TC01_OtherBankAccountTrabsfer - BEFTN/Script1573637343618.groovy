...
if (Mobile.verifyElementExist(findTestObject('Beneficiary Management/Beneficiary/Add Beneficiary - Within City Bank/EmptyBeneficiaryMsg - TransferScreen'), 
    ...
    Mobile.tapAtPosition(GlobalVariable.OtherBankNickname_X, GlobalVariable.OtherBankNickname_Y)
    ...
    Mobile.tap(findTestObject('OtherBankAccount/Transfer Mode - BEFTN (Regular Transfer)'), 0)
