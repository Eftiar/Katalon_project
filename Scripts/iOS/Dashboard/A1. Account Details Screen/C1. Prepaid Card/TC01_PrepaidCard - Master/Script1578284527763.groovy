...
while (Mobile.verifyElementNotExist(findTestObject('Dashboard/A1. AccountDetails/PrepaidCard - MASTER'), 10, FailureHandling.OPTIONAL)) {
...
Mobile.tap(findTestObject('Dashboard/A1. AccountDetails/PrepaidCard - MASTER'), 0)
