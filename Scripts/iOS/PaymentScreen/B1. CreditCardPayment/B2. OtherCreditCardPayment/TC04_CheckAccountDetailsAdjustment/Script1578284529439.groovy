...
String CC_Other_Ammount = ExcelKeywords.getCellValueByIndex(sheet01, 12, 5)

Float CC_Other_Ammount_float = Float.parseFloat(CC_Other_Ammount)
...
Float Ex1_FloatTransfer = Ex1_float - CC_Other_Ammount_float
