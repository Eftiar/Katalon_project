...
Mobile.verifyElementText(findTestObject('Payment Screen/C1. VISA Instant Payment/OTP Screen - From Account'), HolderName)
...
Mobile.setText(findTestObject('Payment Screen/C1. VISA Instant Payment/OTP Screen  - Enter OTP here'), OtpNumber, 
    0)

'Click Transfer Button'
Mobile.tap(findTestObject('Payment Screen/C1. VISA Instant Payment/OTP Screen  - Transfer'), 0)
