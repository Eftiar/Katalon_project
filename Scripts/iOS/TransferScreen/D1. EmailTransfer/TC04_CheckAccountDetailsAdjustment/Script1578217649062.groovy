...
String ET_Ammount = ExcelKeywords.getCellValueByIndex(sheet01, 5, 5)

Float ET_Ammount_float = Float.parseFloat(ET_Ammount)
...
'Not Used For Email Transfer'
Float Ex1_FloatTransfer = Ex1_float - 0.00

'Verify Transfer Amount Not Change'
...
Float Ex2_floatTransfer = Ex2_float - ET_Ammount_float

'Verify Amount Change duw to email transfer'
