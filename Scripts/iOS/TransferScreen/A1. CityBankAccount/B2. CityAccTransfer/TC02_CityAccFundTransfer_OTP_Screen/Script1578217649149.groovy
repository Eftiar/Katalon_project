...
Mobile.verifyElementExist(findTestObject('CityBankAccount/CityAccount/OTP Screen - Within City Account Fund Transfer'), 
    0)

'Get Own Account Transfer Amount from Excel Data Sheet'
String CAT_Amount = ExcelKeywords.getCellValueByIndex(sheet01, 2, 5)

Float CAT_Amount_float = Float.parseFloat(CAT_Amount)
...
Mobile.verifyElementText(findTestObject('CityBankAccount/OwnAccount/OTP Screen - TransferAmount'), CAT_Amount, FailureHandling.CONTINUE_ON_FAILURE)
...
'Verify Service Charge amount "20.00"'
Mobile.verifyElementText(findTestObject('CityBankAccount/OwnAccount/OTP Screen - Service Charge Amn'), '20.00')

String serviceCharge = Mobile.getText(findTestObject('CityBankAccount/OwnAccount/OTP Screen - Service Charge Amn'), 0)
...
Mobile.verifyElementText(findTestObject('CityBankAccount/OwnAccount/OTP Screen - VAT Amn'), '3.00')

String vatAmount = Mobile.getText(findTestObject('CityBankAccount/OwnAccount/OTP Screen - VAT Amn'), 0)
...
GlobalVariable.PO_GrandAmount = grandTotal

Float grandTotalFloat = Float.parseFloat(grandTotal)

Float grandTotalExpected = (CAT_Amount_float + serviceChargeFloat) + vatAmountFloat
