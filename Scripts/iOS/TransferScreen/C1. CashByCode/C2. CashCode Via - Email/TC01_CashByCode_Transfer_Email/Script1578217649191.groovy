...
'User tap on the "Cash by Code" button of "Transfers" screen.'
...
'Select Cah Code Via \'Email\''
Mobile.tap(findTestObject('CashByCode/Cash by Code - Email'), 0)
