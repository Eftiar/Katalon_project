...
Mobile.tap(findTestObject('Beneficiary Management/Beneficiary/Transfer Other Bank - Popup Btn'), 0)
...
Mobile.verifyElementExist(findTestObject('Beneficiary Management/Beneficiary/Delete Beneficiary - Other Bank/Delete Beneficiary - Other Bank Account - Header'), 
    0)
