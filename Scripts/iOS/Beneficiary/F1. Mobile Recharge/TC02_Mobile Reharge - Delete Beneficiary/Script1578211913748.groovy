...
'Verify User is on delete Beneficiary Screen'
Mobile.verifyElementExist(findTestObject('Beneficiary Management/Beneficiary/Delete Beneficiary - Mobile Recharge/Delete Beneficiary - Mobile Recharge - Header'), 
    0)
