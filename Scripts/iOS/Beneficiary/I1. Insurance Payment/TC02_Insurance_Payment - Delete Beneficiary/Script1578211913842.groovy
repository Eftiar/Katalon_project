...
'User select Insurance Payment Type'
...
'Verify User is on Delete Beneciary Screen'
Mobile.verifyElementExist(findTestObject('Beneficiary Management/Beneficiary/Delete Beneficiary - Insurance Payment/Metlife/Delete Beneficiary - Insurance Payment - Header'), 
    0)
